...
// PutBytes stores u in b in big-endian order. It panics if len(b) < 16.
func (u Uint128) PutBytesBigEndian(b []byte) {
...
// FromBytes converts b little-endian order to a Uint128 value.
...
// FromBytes converts b in big-endian order to a Uint128 value.
func FromBytesBigEndian(b []byte) Uint128 {
	return New(
